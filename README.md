YUNCMS Basic Project Template
============================

YUNCMS Basic Project Template is a skeleton [Yii 2](http://www.yiiframework.com/) application best for
...
~~~
php composer.phar create-project --prefer-dist --stability=dev yuncms/yuncms-app-basic basic
~~~
...
Extract the archive file downloaded from [github.com](https://github.com/yuncms/yuncms-app-basic/releases) to
...
return [
    ...
    'dsn' => 'mysql:host=localhost;dbname=yuncms_basic',
    'username' => 'root',
    'password' => '1234',
    'charset' => 'utf8',
];
